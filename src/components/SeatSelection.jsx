...
const MOCK_BOOKED = []; // All seats available by default
...
const SeatSelection = ({ movie: propMovie, onBack: propOnBack }) => {
  ...
  // Called after the user clicks "Done" on the success screen
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-28 pb-40 animate-fade-in text-white">
      ...
      <div
        className={`fixed bottom-0 left-0 w-full bg-slate-900/90 backdrop-blur-xl border-t border-white/10 p-6 transform transition-transform duration-500 z-50 ${
      ...
      >
        <div className="max-w-[1440px] mx-auto flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 px-10 py-4 rounded-xl font-bold bg-cyan-500 hover:bg-cyan-400 text-slate-950 hover:scale-105 hover:shadow-[0_0_20px_rgba(34,211,238,0.4)] transition-all duration-300"
          >
            Proceed to Payment
          </button>
        </div>
